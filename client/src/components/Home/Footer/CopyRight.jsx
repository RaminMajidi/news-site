...
const CopyRight = () => {
    return (
        <div className="has-background-black has-text-white py-4 px-1 mt-4">
            ...
            <p className="column text_center has-text-danger has-text-weight-bold">این سایت صرفا برای دمو و نمایش نمونه کار می باشد و اخبار موجود در آن هیچ ارزش و اعتباری ندارد</p>
